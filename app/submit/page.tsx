      ...
      <div className="container mx-auto px-3">
        ...
        <div className="flex flex-col gap-4 mx-auto my-3 w-full md:w-1/2">
          ...
          <ul className="list-disc">
            <li>
              Lorem ipsum dolor sit, <strong className="text-primary">amet</strong> consectetur
              adipisicing elit. Dolorem, nisi!
            </li>
            <li>
              Lorem ipsum dolor sit, amet consectetur adipisicing{" "}
              <strong className="text-primary">elit</strong>. Dolorem, nisi!
            </li>
            <li>
              Lorem ipsum dolor <strong className="text-primary">sit</strong>, amet consectetur
              adipisicing elit. Dolorem, nisi!
            </li>
          </ul>
        </div>
